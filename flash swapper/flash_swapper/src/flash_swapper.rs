...
pub trait FLASHSWAPPER<Storage: ContractStorage>: ContractContext<Storage> {
    ...
    fn simple_flash_loan(&mut self, _token_borrow: Key, _amount: U256, _is_borrowing_cspr: bool, _is_paying_cspr: bool, _data: String) {
        ...
        let data:String=format!("{}{}{}{}{}{}{}{}{}{}{}{}{}{}","simple_loan",",",_token_borrow,",",_amount,",",_token_borrow,",",_is_borrowing_cspr,",",_is_paying_cspr,",",",",_data);
    ...
    fn simple_flash_loan_execute(&mut self, _token_borrow: Key, _amount: U256, _pair_address: Key, _is_borrowing_cspr: bool, _is_paying_cspr: bool, _user_data: String){
        ...
        if _is_borrowing_cspr {
            let _ret:bool = call_contract(wcspr_hash_add, "withdraw", runtime_args!{"amount" => _amount});
        }
        ...
        // wrap the cspr if necessary
          ...
          if _is_paying_cspr {
           let _ret:bool = call_contract(wcspr_hash_add, "deposit", runtime_args!{"amount" => amount_to_repay});
          }
    ...
    fn simple_flash_swap( &mut self, token_borrow:Key, amount:U256 , token_pay:Key, is_borrowing_cspr:bool , is_paying_cspr:bool , user_data: String ) 
    {
        ...
        if pair_address != address_0 {
            ...
            let data:String=format!("{}{}{}{}{}{}{}{}{}{}{}{}{}{}","simple_swap",",",token_borrow,",",amount,",",token_pay,",",is_borrowing_cspr,",",is_paying_cspr,",",",",user_data);
    ...
    fn simple_flash_swap_execute( &mut self, token_borrow:Key, amount:U256 , token_pay:Key, _pair_address:Key, is_borrowing_cspr:bool , is_paying_cspr:bool , _user_data: String)
    {
        ...
        if is_borrowing_cspr == true
        {
            ...
            let _withdraw_result:bool=runtime::call_contract(wcspr_contract_hash,"withdraw",runtime_args!{"amount" => amount});
        }
        ...
        if is_paying_cspr==true 
        {
            let _deposit_result:bool=runtime::call_contract(wcspr_contract_hash,"deposit",runtime_args!{"amount" => amount_to_repay});
        }
    ...
    fn traingular_flash_swap(&mut self, token_borrow:Key, amount:U256 , token_pay:Key, user_data: String)
    {
        ...
        let borrow_pair_address:Key=runtime::call_contract(uniswap_v2_factory_contract_hash,"getpair",runtime_args!{"token0" => token_borrow,"token1" => wcspr});
        ...
        {
            let permissioned_pair_address:Key=runtime::call_contract(uniswap_v2_factory_contract_hash,"getpair",runtime_args!{"token0" => token_pay,"token1" => wcspr});
            ...
            if pay_pair_address != address_0
            {
                ...
                if pair_balance_token_borrow_before >= amount 
                {
                    ...
                    let pair_balance_wcspr:U256=runtime::call_contract(wcspr_contract_hash,"balanceOf",runtime_args!{"owner" => borrow_pair_address});
    ...
    fn traingular_flash_swap_helper(&mut self,token_borrow:Key,amount:U256, token_pay:Key, borrow_pair_address:Key , pay_pair_address:Key,amount_of_wcspr:U256, user_data:String)
    {
        ...
        let triangle_data :String = format!("{}{}{}",borrow_pair_address,".", amount_of_wcspr);
    ...
    fn traingular_flash_swap_execute(&mut self, token_borrow:Key, amount:U256 , token_pay:Key, triangle_data:String, user_data:String)
    {
        ...
        let _wcspr_transfer_result:bool=runtime::call_contract(wcspr_contract_hash,"transfer",runtime_args!{"recipient" => borrow_pair_address,"amount" => amount_of_wcspr});
        ...
        let pair_balance_wcspr:U256=runtime::call_contract(wcspr_contract_hash,"balanceof",runtime_args!{"owner" => pay_pair_address});
    ...
    // @dev If you entered `0x0` for _token_pay when you called `flashSwap`, then make sure this contract holds _amount cspr before this
    //     finishes executing
